...
$_['entry_description']   = 'Descrição do cupom:';
$_['entry_code']          = 'Codigo:<br /><span class="help">O código que o cliente entra para obter o desconto</span>';
...
$_['entry_total']         = 'Valor total:<br /><span class="help">O valor da compra necessário para permitir o uso do cupom.</span>';
...
$_['error_description']   = 'Descrição do cupom deve possuir mais de 3 caracteres!';
