...
$_['entry_url']               = 'URL da loja:<br /><span class="help">URL completo para a sua loja. Certifique-se de adicionar \'/\' no final. Exemplo: "http://www.sualoja.com/". Não use os diretórios para criar uma nova loja. Você deve sempre apontar um outro domínio ou subdomínio para sua hospedagem.</span>';
...
$_['entry_customer_price']    = 'Autenticado para mostrar preços:<br /><span class="help">Apenas mostrar os preços quando o cliente estiver autenticado.</span>';
...
$_['entry_guest_checkout']    = 'Comprar como visitante:<br /><span class="help">Permitir que os clientes comprem sem possuir cadastro. Isso não estará disponível quando um produto para download estiver no carrinho de compras.</span>';
...
$_['entry_stock_check']       = 'Verificar estoque:<br /><span class="help">Exibe uma mensagem "Fora de Estoque" na página do carrinho se o produto estiver esgotado.</span>';
$_['entry_stock_checkout']    = 'Venda sem estoque:<br /><span class="help">Permitir aos clientes comprar o produto mesmo quando fora de estoque.</span>';
...
$_['button_delete_store']     = 'Excluir loja';

// Error
$_['error_permission']        = 'Atenção: Você não possui permissão para modificar as lojas!';
$_['error_name']              = 'Nome da loja deve possuir de 3 a 32 caracteres!';
$_['error_url']               = 'O campo <em>URL da loja</em> é obrigatório!';
$_['error_title']             = 'Título deve possuir de 3 a 32 caracteres!';
$_['error_image_thumb']       = 'Tamanho das miniaturas do produto é obrigatório!';
$_['error_image_popup']       = 'Tamanho das imagens de ampliação é obrigatório!';
$_['error_image_category']    = 'Tamanho das imagens das categorias é obrigatório!';
$_['error_image_product']     = 'Tamanho das imagens da lista de produtos é obrigatório!';
$_['error_image_additional']  = 'Tamanho das imagens adicionais dos produtos é obrigatório!';
$_['error_image_related']     = 'Tamanho das imagens dos produtos relacionados é obrigatório!';
$_['error_image_cart']        = 'Tamanho das miniaturas no carrinho é obrigatório!';
$_['error_store']             = 'Atenção: Esta loja não pode ser excluída pois possui %s pedido(s) atribuído(s) a ela!';
$_['error_required_data']     = 'Alguns campos não foram preenchidos corretamente!';
