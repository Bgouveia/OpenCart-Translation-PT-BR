...
$_['entry_commission']        = 'Comissão do afiliado (%):<br /><span class="help">Percentual padrão que o afiliado receberá de comissão.</span>';
$_['entry_complete_status']   = 'Status de pedido completo:<br /><span class="help">Definir o status do pedido que o cliente terá para obter acesso aos produtos (disponíveis por download) e aos vouchers para presente.</span>';
$_['entry_return_status']     = 'Situação de troca:<br /><span class="help">Defina a situação de troca quando uma solicitação para trocar um produto é submetida.</span>';
$_['entry_upload_allowed']    = 'Extensões de arquivo permitidas para upload:<br /><span class="help">Adicione as extensões de arquivos permitidas para os usuários efetuarem upload. Use vírgula para separar.</span>';
...
$_['entry_image_manufacturer']        = 'Tamanho da imagem do fabricante:';
$_['entry_image_compare']        = 'Tamanho da imagem para comparação:';
$_['entry_image_wishlist']        = 'Tamanho da imagem para lista de desejos:';
...
$_['entry_use_ssl']               = 'Usar SSL:<br /><span class="help">É necessário verificar com o servidor se o certificado SSL está instalado.</span>';
...
$_['entry_google_analytics']  = 'Código do Google Analytics:<br /><span class="help">Entre na sua conta do <a onclick="window.open(\'http://www.google.com/analytics/\');"><u>Google Analytics</u></a> e após criar o perfil do site, copie e cole o código do site neste campo.</span>';
