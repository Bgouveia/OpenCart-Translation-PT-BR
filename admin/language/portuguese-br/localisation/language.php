...
$_['error_name']		= 'Nome do idioma deve possuir de 3 a 32 caracteres!';
$_['error_code']		= 'Código do idioma deve possuir ao menos 2 caracteres!';
$_['error_only']        = 'Você não pode apagar pois é a linguagem padrão!';
$_['error_locale']		= 'O campo <em>Localização</em> é obrigatório!';
$_['error_image']		= 'Nome da imagem deve possuir de 3 a 64 caracteres!';
$_['error_directory']	= 'O campo <em>Pasta</em> é obrigatório!';
$_['error_filename']	= 'Nome do arquivo deve possuir de 3 a 64 caracteres!';
