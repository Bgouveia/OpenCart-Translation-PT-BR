...
$_['error_username']	= 'O campo <em>Usuário API</em> é requerido!'; 
$_['error_password']	= 'O campo <em>Senha API</em> é requerido!'; 
$_['error_signature']	= 'O campo <em>Assinatura API</em> é requerido!'; 
?>